...
// SPINDLE_ENABLE_PORT ^= 1<<SPINDLE_ENABLE_BIT; // Debug: Used to time ISR
  ...
  // Then pulse the stepping pins
  #ifdef STEP_PULSE_DELAY
    st.step_bits[1] = (STEP_PORT1 & ~STEP_MASK1) | ((st.step_outbits<<3) & STEP_MASK1); // Store out_bits to prevent overwriting.
  #else  // Normal operation
    STEP_PORT1 = (STEP_PORT1 & ~STEP_MASK1) | (st.step_outbits<<3) & STEP_MASK1;
  #endif
...
void st_reset()
{
  ...
  STEP_PORT1 = (STEP_PORT1 & ~STEP_MASK1) | ((step_port_invert_mask<<3)&STEP_MASK1);
